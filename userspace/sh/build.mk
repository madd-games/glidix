...
out/sh: build/src__cd.o build/src__echo.o build/src__sh.o build/src__command.o build/src__exit.o
	x86_64-glidix-gcc -o $@ $^
-include build/src__cd.d build/src__echo.d build/src__sh.d build/src__command.d build/src__exit.d
