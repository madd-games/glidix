...
DEP := $(OBJ:.o=.d)
CFLAGS := -ffreestanding -mcmodel=large -mno-red-zone -mno-mmx -mno-sse -mno-sse2 -fno-common -fno-builtin -fno-omit-frame-pointer -I $(SRCDIR)/include -I $(SRCDIR)/include/acpi -D__KERNEL__ -DCONFIG_ACPI -Wall -Werror
